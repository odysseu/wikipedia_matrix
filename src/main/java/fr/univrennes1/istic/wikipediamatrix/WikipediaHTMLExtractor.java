...
public class WikipediaHTMLExtractor {
	...
	public static String[] ignoreType = {
			"box-Copyvio-revdel plainlinks metadata ambox ambox-delete",
			...
			"box-Overcoloured plainlinks metadata ambox ambox-style",
			...
			"sidebar nomobile hlist",
			"sidebar nomobile vcard plainlist",
			"box-Merge_from plainlinks metadata ambox ambox-move",
			"box-RedirectBox plainlinks metadata ambox ambox-notice",
			"plainlinks fmbox fmbox-system",
			"box-RfD plainlinks metadata ambox ambox-delete",
			"box-Lead_missing plainlinks metadata ambox ambox-content ambox-lead_missing",
			"box-Condense plainlinks metadata ambox ambox-style ambox-condense",
			"plainlinks metadata ambox ambox-move",
			"box-Cleanup-list plainlinks metadata ambox ambox-style",
			...
			"infobox-subbox",
			"box-Cleanup_bare_URLs plainlinks metadata ambox ambox-style ambox-cleanup-link_rot",
